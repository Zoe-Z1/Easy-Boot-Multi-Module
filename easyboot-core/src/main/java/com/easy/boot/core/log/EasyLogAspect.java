...
import com.easy.boot.core.log.enums.OperateStatusEnum;
import com.easy.boot.core.log.enums.OperateTypeEnum;
import com.easy.boot.core.log.enums.RoleTypeEnum;
import com.easy.boot.core.properties.EasyLogFilter;
...
public class EasyLogAspect {
    ...
    @Resource
    private com.easy.boot.core.properties.EasyLog easyLog;
     ...
     * 配置织入点
     */
    @Pointcut("@annotation(com.easy.boot.core.log.EasyLog)")
