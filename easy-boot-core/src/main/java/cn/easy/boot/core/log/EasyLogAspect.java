...
public class EasyLogAspect {
    ...
    @Resource
    private cn.easy.boot.core.properties.EasyLog easyLog;
     ...
     * 配置织入点
     */
    @Pointcut("@annotation(cn.easy.boot.core.log.EasyLog)")
