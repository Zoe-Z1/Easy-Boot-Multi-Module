package cn.easy.boot.core.noRepeatSubmit;
...
import cn.easy.boot.core.redis.EasyRedisManager;
...
public class EasyNoRepeatSubmitAspect {
    ...
    @Resource
    private cn.easy.boot.core.properties.EasyNoRepeatSubmit easyNoRepeatSubmit;
     ...
     * 配置织入点
     */
    @Pointcut("@annotation(cn.easy.boot.core.noRepeatSubmit.EasyNoRepeatSubmit)")
