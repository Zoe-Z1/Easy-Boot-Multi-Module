package cn.easy.boot.core.redisson;

import cn.hutool.core.util.StrUtil;
import cn.easy.boot.core.redis.RedisKeyEnum;
import cn.easy.boot.core.exception.LockException;
...
public class EasyLockAspect {
    ...
    @Resource
    private cn.easy.boot.core.properties.EasyLock globalEasyLock;

    /**
     * 配置织入点
     */
    @Pointcut("@annotation(cn.easy.boot.core.redisson.EasyLock)")
    ...
    public Object around(ProceedingJoinPoint point) throws Throwable {
        ...
        cn.easy.boot.core.properties.EasyLock lock = this.getLock(annotation, method, args);
     ...
     * @return
     */
    private cn.easy.boot.core.properties.EasyLock getLock(EasyLock easyLock, Method method, Object[] args) {
        ...
        return cn.easy.boot.core.properties.EasyLock.builder()
                .leaseTime(leaseTime)
                .waitTime(waitTime)
                .build();
    }
