package com.easy.boot.core.noRepeatSubmit;

import cn.dev33.satoken.stp.StpUtil;
import cn.hutool.core.net.NetUtil;
import cn.hutool.core.util.StrUtil;
import com.easy.boot.core.exception.BusinessException;
import com.easy.boot.core.exception.enums.SystemErrorEnum;
import com.easy.boot.core.redis.EasyRedisManager;
import com.easy.boot.core.redis.RedisKeyEnum;
import com.easy.boot.core.utils.IpUtil;
...
public class EasyNoRepeatSubmitAspect {
    ...
    @Resource
    private com.easy.boot.core.properties.EasyNoRepeatSubmit easyNoRepeatSubmit;
     ...
     * 配置织入点
     */
    @Pointcut("@annotation(com.easy.boot.core.noRepeatSubmit.EasyNoRepeatSubmit)")
    ...
    private String getKey(JoinPoint joinPoint){
        ...
        if (StpUtil.isLogin()) {
            value = StpUtil.getLoginId() + ":" + value;
        }
