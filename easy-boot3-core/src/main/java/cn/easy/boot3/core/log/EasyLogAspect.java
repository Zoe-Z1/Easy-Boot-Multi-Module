package cn.easy.boot3.core.log;
...
import cn.easy.boot3.core.properties.EasyLogFilter;
...
public class EasyLogAspect {
    ...
    @Resource
    private cn.easy.boot3.core.properties.EasyLog easyLog;
     ...
     * 配置织入点
     */
    @Pointcut("@annotation(cn.easy.boot3.core.log.EasyLog)")
