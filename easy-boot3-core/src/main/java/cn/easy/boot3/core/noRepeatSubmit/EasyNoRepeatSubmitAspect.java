package cn.easy.boot3.core.noRepeatSubmit;
...
public class EasyNoRepeatSubmitAspect {
    ...
    @Resource
    private cn.easy.boot3.core.properties.EasyNoRepeatSubmit easyNoRepeatSubmit;
     ...
     * 配置织入点
     */
    @Pointcut("@annotation(cn.easy.boot3.core.noRepeatSubmit.EasyNoRepeatSubmit)")
