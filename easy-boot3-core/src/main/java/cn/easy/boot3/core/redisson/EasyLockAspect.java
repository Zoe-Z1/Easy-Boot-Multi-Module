package cn.easy.boot3.core.redisson;

import cn.hutool.core.util.StrUtil;
import cn.easy.boot3.core.exception.LockException;
...
public class EasyLockAspect {
    ...
    @Resource
    private cn.easy.boot3.core.properties.EasyLock globalEasyLock;

    /**
     * 配置织入点
     */
    @Pointcut("@annotation(cn.easy.boot3.core.redisson.EasyLock)")
    ...
    public Object around(ProceedingJoinPoint point) throws Throwable {
        ...
        cn.easy.boot3.core.properties.EasyLock lock = this.getLock(annotation, method, args);
     ...
     * @return
     */
    private cn.easy.boot3.core.properties.EasyLock getLock(EasyLock easyLock, Method method, Object[] args) {
        ...
        return cn.easy.boot3.core.properties.EasyLock.builder()
                .leaseTime(leaseTime)
                .waitTime(waitTime)
                .build();
    }
