package com.easy.boot3.core.noRepeatSubmit;
...
public class EasyNoRepeatSubmitAspect {
    ...
    @Resource
    private com.easy.boot3.core.properties.EasyNoRepeatSubmit easyNoRepeatSubmit;
     ...
     * 配置织入点
     */
    @Pointcut("@annotation(com.easy.boot3.core.noRepeatSubmit.EasyNoRepeatSubmit)")
