package com.easy.boot3.core.redisson;

import cn.hutool.core.util.StrUtil;
import com.easy.boot3.core.exception.LockException;
...
public class EasyLockAspect {
    ...
    @Resource
    private com.easy.boot3.core.properties.EasyLock globalEasyLock;

    /**
     * 配置织入点
     */
    @Pointcut("@annotation(com.easy.boot3.core.redisson.EasyLock)")
    ...
    public Object around(ProceedingJoinPoint point) throws Throwable {
        ...
        com.easy.boot3.core.properties.EasyLock lock = this.getLock(annotation, method, args);
     ...
     * @return
     */
    private com.easy.boot3.core.properties.EasyLock getLock(EasyLock easyLock, Method method, Object[] args) {
        ...
        return com.easy.boot3.core.properties.EasyLock.builder()
                .leaseTime(leaseTime)
                .waitTime(waitTime)
                .build();
    }
