package com.easy.boot3.core.saToken;

import cn.dev33.satoken.SaManager;
import cn.dev33.satoken.stp.StpLogic;
import cn.dev33.satoken.stp.StpUtil;
import com.easy.boot3.core.log.enums.RoleTypeEnum;
import com.easy.boot3.core.redis.RedisKeyEnum;
...
public class UserContext {
     ...
     * @return
     */
    public static void login(SaCache user) {
     ...
     * @param saCache
     */
    public static void setAdminUser(Long id, SaCache saCache) {
        setAdminUser(id, saCache, -1);
    }
     ...
     * @param timeout
     */
    public static void setAdminUser(Long id, SaCache saCache, long timeout) {
        SaManager.getSaTokenDao().setObject(RedisKeyEnum.SA_USER_DETAIL.getKey(id), saCache, timeout);
    }
     ...
     * @return
     */
    public static SaCache getAdminUser() {
        Long id = getId();
     ...
     * @return
     */
    public static SaCache getAdminUser(Long id) {
        SaCache user = (SaCache) SaManager.getSaTokenDao().getObject(RedisKeyEnum.SA_USER_DETAIL.getKey(id));
        return user;
    }
